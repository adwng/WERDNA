...
def generate_launch_description():
    ...
    xacro_file = os.path.join(package_path, 'urdf', 'werdna.xacro')
    robot_description_config=xacro.process_file(xacro_file)
    robot_urdf = robot_description_config.toxml()

    rviz_path = get_package_share_directory("bringup")
    rviz_file = os.path.join(rviz_path, 'configs', 'display.rviz')
